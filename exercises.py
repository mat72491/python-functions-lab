...
def convert_temperature(C):
    return (C * (9/5) + 32)
# print('Exercise 4: Convert 0°C to Fahrenheit:', convert_temperature(0))


def convert_temperature(F):
    return (F - 32) * 5/9
# print('Exercise 4: Convert 32°F to Celsius:', convert_temperature(32))
...
print('Exercise 9 Result:', basicCalculator(10, 1, "divide"))
